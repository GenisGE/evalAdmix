...
void adaptF(double **F, double **newF, int  **G, int K, double **Q, int N, int M, int withoutInd, int nIts, double **aNorm, double **bNorm, double *init_Nk){
...
void evalAdmix(double *cor, int ind1, double **r, double *mean_r, int **G, int K, double **Q, double **F, int nInd, int nSites,int nIts, double *sumQ){
   fprintf(stderr, "called evalAdmix with ind %d, going to create variables\n",ind1);
    ...
    adaptF(F, fAdapted, G, K, Q, nInd, nSites, ind1, nIts, aNorm, bNorm, sumQ);
